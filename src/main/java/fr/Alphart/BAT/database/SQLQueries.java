...
public class SQLQueries {
	...
	public static class Comments{
		...
		public static final String insertEntry = "INSERT INTO `" + table + "` (entity, note, type, staff, notified)"
				+ "VALUES (?, ?, ?, ?, ?);";
		...
		public static final String markNotified = "UPDATE `" + table + "` SET `notified`=1 WHERE `entity`=? && `notified`=0;";
		public static final String getNotifications = "SELECT `note` FROM " + table + " WHERE `entity`=? && `notified`=0 ORDER BY date DESC;";
		...
		public static class SQLite{
			...
			public static final String markNotified = "UPDATE `" + table + "` SET `notified`=1 WHERE `entity`=? && `notified`=0;";
			public static final String getNotifications = "SELECT id, note FROM " + table + " WHERE `entity`=? && `notified`=0 ORDER BY date DESC;";
		}
	}
